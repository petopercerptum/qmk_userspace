...
#define DILEMMA_AUTO_POINTER_LAYER_TRIGGER_TIMEOUT_MS 500
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // ╰──────────────────────────────────────────────────────┤ ├──────────────────────────────────────────────────────╯
                          TO_NUM, KC_LBRC,  KC_SPC, KC_BSPC,     KC_TAB,  KC_ENT, KC_RBRC,  KC_ESC
  //                    ╰───────────────────────────────────╯ ╰───────────────────────────────────╯
  ),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [LAYER_LOWER]      = {ENCODER_CCW_CW(KC_LEFT, KC_RIGHT), ENCODER_CCW_CW(KC_UP, KC_DOWN)},
    [LAYER_RAISE]      = {ENCODER_CCW_CW(KC_LEFT, KC_RIGHT), ENCODER_CCW_CW(KC_UP, KC_DOWN)},
